"""
Fixed-memory HNSW implementation using node pools.
Solves the std::bad_alloc issue by pre-allocating all memory upfront.

Based on state-of-the-art patterns from Modular's stdlib.
"""
...
struct NodePool:
    ...
    """
    var nodes: UnsafePointer[FixedHNSWNode]
    var capacity: Int
    var size: Int
    ...
    fn __init__(out self, capacity: Int):
        ...
        self.size = 0
        self.nodes = UnsafePointer[FixedHNSWNode].alloc(capacity)
    ...
    @always_inline
    fn get(self, idx: Int) -> UnsafePointer[FixedHNSWNode]:
        """Get node by index."""
